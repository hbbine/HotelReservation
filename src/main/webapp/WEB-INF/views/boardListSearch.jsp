    ...
    <div class="container-custom">
		...
		<div>
			<ul class="pagination">
				...
				<a class="page-link" href="${pageContext.request.contextPath}/boardListSearch?page=${pagedto.page - 1}&searchType=${pagedto.searchType}&keyword=${pagedto.keyword}"
				...
				<c:forEach var="i" begin="${pagedto.startNum}" end="${pagedto.lastNum}">
					...
					<a class="page-link" href="${pageContext.request.contextPath}/boardListSearch?page=${i}&searchType=${pagedto.searchType}&keyword=${pagedto.keyword}"
						style="${pagedto.page == i ? 'font-weight: bold;' : ''}">${i}</a>
					</li>
				</c:forEach>
