...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="${pageContext.request.contextPath}/map" class="dropdown-item">오시는길</a>
    ...
    <!-- Header Start -->
    <div>
    <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/lobby.jpg" alt="" />
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/hotel3.jpg" alt="" />
