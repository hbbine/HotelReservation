        ...
        <div class="col-lg-8 col-md-12 wow fadeInUp">
				<div class="boardViewForm">
					...
					<div class="col-12 mt-3 d-flex justify-content-between align-items-center">
						<a href="${pageContext.request.contextPath}/admin/adminPost" class="btn btn-primary w-45"> 목록 </a>
						<div class="d-flex gap-3">
							<a href="${pageContext.request.contextPath}/admin/updateAdminPost?b_id=${board.b_id}" onclick="updateBoard'${board.m_id}')"
								class="btn btn-custom w-45"> 수정 </a>
							<a href="${pageContext.request.contextPath}/admin/deleteAdminPost?b_id=${board.b_id}"
